...
public final class ASomeFunctionDefList extends PFunctionDefList
{
    private PFunctionDef _functionDef_;
    private PFunctionDefList _functionDefList_;

    public ASomeFunctionDefList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASomeFunctionDefList(
    ...
    {
        ((Analysis) sw).caseASomeFunctionDefList(this);
    }
