...
public final class AFunctionCallPrimeExp extends PPrimeExp
{
    private TId _id_;
    ...
    public Object clone()
    {
        return new AFunctionCallPrimeExp(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAFunctionCallPrimeExp(this);
    }
