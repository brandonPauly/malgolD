...
public class PrettyPrintVisitor implements ASTVisitor {
	...
	public void visit(GotoStatement s) {
		throw new RuntimeException("Encountered GOTO in PrettyPrint");
	}

	@Override
	public void visit(DereferenceExpression e) {
		throw new RuntimeException("Encountered dereference expression in PrettyPrint"); 
	}

	@Override
	public void visit(OffsetExpression e) {
		throw new RuntimeException("Encountered offset expression in PrettyPrint");
	}
